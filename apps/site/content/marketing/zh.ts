    ...
    screenshots: [
      {
        ...
        alt: "聊天界面",
        caption: "多会话聊天，支持 Code、Plan、Ask 模式",
      },
      {
        src: "/screenshots/providers.svg",
        alt: "Provider 管理",
        caption: "连接并切换多个 AI 提供商",
      },
      {
        src: "/screenshots/mcp-skills.svg",
        alt: "MCP 和 Skills",
        caption: "通过 MCP 和 Skills 扩展能力",
      },
      {
  ...
  openSource: {
    ...
    highlights: [
      ...
      },
      {
        ...
        title: "自带 Key",
        description:
          "直连 Anthropic、OpenAI、Google 或任何 Provider，使用你自己的 API Key。",
      },
      {
        icon: "Users",
        title: "社区驱动",
