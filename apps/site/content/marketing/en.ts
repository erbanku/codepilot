...
export const en: MarketingContent = {
    ...
    screenshots: [
      {
        ...
        alt: "Chat interface",
        caption: "Multi-session chat with Code, Plan, and Ask modes",
      },
      {
        src: "/screenshots/providers.svg",
        alt: "Provider management",
        caption: "Connect and switch between AI providers",
      },
      {
        src: "/screenshots/mcp-skills.svg",
        alt: "MCP and Skills",
        caption: "Extend with MCP servers and Skills",
      },
      {
        src: "/screenshots/workspace.svg",
        alt: "Assistant Workspace",
        caption: "Inspect files and review changes in real time",
      },
      {
        src: "/screenshots/bridge.svg",
        alt: "Bridge messaging",
        caption: "Continue conversations from your phone",
      },
    ],
  },
  features: {
    ...
    titleLight:
      "Conversations, 17+ providers, MCP extensions, and project context — in one place.",
    subtitle: "",
    items: [
      {
        icon: "MessageSquare",
  ...
  openSource: {
    ...
    githubUrl: "https://github.com/erbanku/CodePilot",
  },
  faq: {
  ...
  audience: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Switch between providers and MCP servers without friction.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Continue tasks from your phone while Claude keeps working.",
      },
    ],
  },
  quickstart: {
  ...
  docs: {
    ...
    cards: [
      ...
      {
        title: "Workspace",
        description: "File inspection and context.",
        href: "/docs/workspace",
      },
    ],
  },
  ...
  footer: {
    ...
    links: [
      { text: "GitHub", url: "https://github.com/erbanku/CodePilot" },
      { text: "Docs", url: "/docs" },
