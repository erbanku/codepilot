...
| Windows          | [インストーラー (.exe)](https://github.com/erbanku/CodePilot/releases/latest)                                                                       | x64 + arm64    |
| Linux            | ソースからビルド                                                                                                                                    | x64 + arm64    |

または [Releases](https://github.com/erbanku/CodePilot/releases) ページで全バージョンを確認できます。
...
- [GitHub Issues](https://github.com/erbanku/CodePilot/issues) -- バグ報告と機能リクエスト
- [GitHub Discussions](https://github.com/erbanku/CodePilot/discussions) -- 質問と一般的なディスカッション
...
- **個人 / 学術 / 非営利利用**: 無料かつ無制限
- **商用利用**: 別途ライセンスが必要 — 連絡先: [@erbanku on X](https://x.com/erbanku)
