...
| Windows | [安装包 (.exe)](https://github.com/erbanku/CodePilot/releases/latest)                                                                               | x64 + arm64 |
| Linux   | 从源码构建                                                                                                                                          | x64 + arm64 |

或访问 [Releases](https://github.com/erbanku/CodePilot/releases) 页面获取所有版本。
...
- **个人 / 学术 / 非营利用途**：免费且无限制
- **商业用途**：需要单独许可 — 联系 [@erbanku on X](https://x.com/erbanku)
