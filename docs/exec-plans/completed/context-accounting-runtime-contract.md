...
- 2026-05-20（**Phase 7 实施完成 commit `80eb959`**）：8 个子阶段一口气落地（7.7 真实凭据 smoke 等用户跑除外）：
  ...
  - **7.1** Widget message golden fixture (src/**tests**/fixtures/widget-message-tool-uses.json) — DB row 487c190a 抽 5 个 tool_use 100% tool_result 配对率
...
| entries.mcp (mcp\_\_ 前缀 split)          | ✅ (fixture 验证)                            | ✅ (同 collector)               | ✅ (同 collector)         |
