...
const zh: Record<TranslationKey, string> = {
  ...
  'chatList.selectSessions': '选择',
  'chatList.selectionCount': '已选 {count} 项',
  'chatList.archiveSelected': '归档选中',
  'chatList.deleteSelected': '删除选中',
  'chatList.bulkDeleteConfirm': '确认删除 {count} 条对话？此操作不可撤销。',
  'chatList.bulkArchiveConfirm': '确认归档 {count} 条对话？',
  'chatList.archiveConversation': '归档对话',
  'chatList.unarchiveConversation': '取消归档',
  'chatList.timeSectionToday': '今天',
  'chatList.timeSectionLast7days': '最近 7 天',
  'chatList.timeSectionLast30days': '最近 30 天',
  'chatList.timeSectionOlder': '更早',
  'chatList.cancelSelection': '取消',
  ...
  'settings.uiFontFamilyDesc': '设置界面文字字体',
  'settings.uiFontFamilyPlaceholder': '如 Inter, system-ui',
  'settings.codeFontFamily': '代码字体',
  'settings.codeFontFamilyDesc': '设置代码块字体',
  'settings.codeFontFamilyPlaceholder': '如 JetBrains Mono, Fira Code',
  'settings.uiFontSize': '界面字号',
  'settings.uiFontSizeDesc': '设置界面基础字号（px）',
  'settings.codeFontSize': '代码字号',
  'settings.codeFontSizeDesc': '设置代码块字号（px）',
  'settings.backup': '备份与同步',
  'settings.backupDesc': '导出、导入和同步你的 CodePilot 配置',
  'settings.backup.export': '导出配置',
  'settings.backup.exportDesc': '下载所有设置、服务商和模型为备份文件',
  'settings.backup.exportButton': '下载备份',
  'settings.backup.import': '导入配置',
  'settings.backup.importDesc': '从之前导出的备份文件恢复设置',
  'settings.backup.importButton': '导入文件',
  'settings.backup.importSuccess': '配置已恢复成功，请重新加载应用。',
  'settings.backup.importFailed': '导入失败，请检查文件格式。',
  'settings.backup.webdav': 'WebDAV 同步',
  'settings.backup.webdavDesc': '将备份同步到 WebDAV 服务器（如 Nextcloud、ownCloud、NAS）',
  'settings.backup.webdav.configured': '已配置',
  'settings.backup.webdav.notConfigured': '未配置',
  'settings.backup.webdav.url': 'WebDAV 服务器地址',
  'settings.backup.webdav.username': '用户名',
  'settings.backup.webdav.password': '密码',
  'settings.backup.webdav.path': '备份路径',
  'settings.backup.webdav.pathDesc': '备份的远程目录路径（如 /codepilot/backups）',
  'settings.backup.webdav.test': '测试连接',
  'settings.backup.webdav.save': '保存并连接',
  'settings.backup.webdav.disconnect': '断开连接',
  'settings.backup.webdav.testing': '正在测试连接...',
  'settings.backup.webdav.pushNow': '立即推送备份',
  'settings.backup.webdav.pushing': '正在推送备份...',
  'settings.backup.webdav.remoteBackups': '远程备份',
  'settings.backup.webdav.noBackups': '服务器上没有找到备份',
  'settings.backup.webdav.pull': '从服务器恢复',
  'settings.backup.webdav.delete': '从服务器删除',
  'settings.backup.webdav.pullConfirm': '这将覆盖所有当前设置，确定继续？',
