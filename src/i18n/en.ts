...
const en = {
  ...
  'chatList.selectSessions': 'Select',
  'chatList.selectionCount': '{count} selected',
  'chatList.archiveSelected': 'Archive Selected',
  'chatList.deleteSelected': 'Delete Selected',
  'chatList.bulkDeleteConfirm': 'Delete {count} conversation(s)? This cannot be undone.',
  'chatList.bulkArchiveConfirm': 'Archive {count} conversation(s)?',
  'chatList.archiveConversation': 'Archive Conversation',
  'chatList.unarchiveConversation': 'Unarchive Conversation',
  'chatList.timeSectionToday': 'Today',
  'chatList.timeSectionLast7days': 'Last 7 days',
  'chatList.timeSectionLast30days': 'Last 30 days',
  'chatList.timeSectionOlder': 'Older',
  'chatList.cancelSelection': 'Cancel',
  ...
  'settings.uiFontFamilyDesc': 'Set the font family for the user interface',
  'settings.uiFontFamilyPlaceholder': 'e.g. Inter, system-ui',
  'settings.codeFontFamily': 'Code Font',
  'settings.codeFontFamilyDesc': 'Set the font family for code blocks',
  'settings.codeFontFamilyPlaceholder': 'e.g. JetBrains Mono, Fira Code',
  'settings.uiFontSize': 'UI Font Size',
  'settings.uiFontSizeDesc': 'Set the base font size for the interface (px)',
  'settings.codeFontSize': 'Code Font Size',
  'settings.codeFontSizeDesc': 'Set the font size for code blocks (px)',
  'settings.backup': 'Backup & Sync',
  'settings.backupDesc': 'Export, import, and sync your CodePilot configuration',
  'settings.backup.export': 'Export Configuration',
  'settings.backup.exportDesc': 'Download all settings, providers, and models as a backup file',
  'settings.backup.exportButton': 'Download Backup',
  'settings.backup.import': 'Import Configuration',
  'settings.backup.importDesc': 'Restore settings from a previously exported backup file',
  'settings.backup.importButton': 'Import File',
  'settings.backup.importSuccess': 'Configuration restored successfully. Please reload the app.',
  'settings.backup.importFailed': 'Import failed. Check the file format.',
  'settings.backup.webdav': 'WebDAV Sync',
  'settings.backup.webdavDesc': 'Sync backups to a WebDAV server (e.g., Nextcloud, ownCloud, NAS)',
  'settings.backup.webdav.configured': 'Configured',
  'settings.backup.webdav.notConfigured': 'Not configured',
  'settings.backup.webdav.url': 'WebDAV Server URL',
  'settings.backup.webdav.username': 'Username',
  'settings.backup.webdav.password': 'Password',
  'settings.backup.webdav.path': 'Backup Path',
  'settings.backup.webdav.pathDesc': 'Remote directory path for backups (e.g., /codepilot/backups)',
  'settings.backup.webdav.test': 'Test Connection',
  'settings.backup.webdav.save': 'Save & Connect',
  'settings.backup.webdav.disconnect': 'Disconnect',
  'settings.backup.webdav.testing': 'Testing connection...',
  'settings.backup.webdav.pushNow': 'Push Backup Now',
  'settings.backup.webdav.pushing': 'Pushing backup...',
  'settings.backup.webdav.remoteBackups': 'Remote Backups',
  'settings.backup.webdav.noBackups': 'No backups found on server',
  'settings.backup.webdav.pull': 'Restore from server',
  'settings.backup.webdav.delete': 'Delete from server',
  'settings.backup.webdav.pullConfirm': 'This will overwrite all current settings. Continue?',
